...
// Classe PersonSelect é responsável por iniciar as telas de inicío e logo depois a tela de seleção
// de personagem
public class PersonSelect extends Application {
    ...
    private void showCharacterSelection() {
        // Knight
        VBox knightBox = createCharacterBox("res/knight.png", "Knight");
