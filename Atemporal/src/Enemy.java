...
// esta classe possui como atributo uma imagem que será usada para representar o inimigo no mapa
public class Enemy extends ImageView {
    ...
    private void loadImages() {
        ...
        skhurt[0] = new Image("/res/skhurt0.png");
        skhurt[1] = new Image("/res/skhurt1.png");
    ...
    private void enemy_timelines() {
        ...
        hurt = new Timeline(new KeyFrame(Duration.millis(2000), e -> {
            indexHurt = (indexHurt + 1) % skhurt.length;
            setImage(skhurt[indexHurt]);
        }));
        hurt.setCycleCount(skhurt.length);
    }
...
//    public boolean enemy_collision_player(Player player){
//        if(getX() <= player.getImageView().getX() + player.getWidth()){
//            System.out.println("enemy position: " + getX());
//            return true;
//        }
//        return false;
//    }
    ...
    public Timeline getHurt(){return hurt;}
